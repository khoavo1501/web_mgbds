    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">Theo dõi và quản lý các cuộc hẹn xem nhà của khách hàng.</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-1.5 mb-6 flex items-center justify-between">
          <div className="flex items-center gap-1">
            ...
            >
              Sắp tới ({appointments.filter(a => ['pending', 'confirmed', 'scheduled'].includes(a.status)).length})
            </button>
            <button
